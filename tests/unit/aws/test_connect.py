...
class TestClientFactory:
    ...
    def test_internal_call_from_principal(self, create_dummy_request_parameter_gateway):
        ...
        factory(
            ...
            aws_access_key_id="LSIA_TEST_PRINCIPAL_01",
            aws_secret_access_key="bar",
        ).lambda_.list_functions()

        assert test_params == {"is_internal": True, "access_key_id": "LSIA_TEST_PRINCIPAL_01"}
    ...
    def test_internal_call_from_role(self, create_dummy_request_parameter_gateway):
        ...
        assert test_params == {"is_internal": True, "access_key_id": "LSIA_TEST_ASSUMED_ROLE_01"}
