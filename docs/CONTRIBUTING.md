...
- [Development Environment Setup](/docs/contributing/development-environment-setup/README.md)
- [LocalStack Concepts](/docs/reference/concepts/README.md)
- [Testing](/docs/reference/testing/README.md)
...
* Follow the existing code style. Run `make format` and `make lint` before checking in your code.
  * Refer to [Development Environment Setup](/docs/contributing/development-environment-setup/README.md) if your local testing environment is not yet properly set up.
