...
from localstack.aws.services.s3.models import s3_stores
from localstack.aws.services.s3.utils import TAG_REGEX
from localstack.aws.services.s3control.exceptions import NoSuchResource
