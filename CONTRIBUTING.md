...
- [Development Environment Setup](./contributing/development-environment-setup/README.md)
- [LocalStack Concepts](./reference/concepts/README.md)
...
* Add tests for any new features or bug fixes. Ideally, each PR increases the test coverage. Please read our [integration testing](./reference/testing/integration-tests/README.md) and [parity testing](./reference/testing/parity-testing/README.md) guides on how to write tests for AWS services.
* Follow the existing code style. Run `make format` and `make lint` before checking in your code.
  * Refer to [Development Environment Setup](./contributing/development-environment-setup/README.md) if your local testing environment is not yet properly set up.
...
Please note that by contributing any code or documentation to this repository (by raising PRs, or otherwise) you explicitly agree to the [**Contributor License Agreement**](https://github.com/localstack/localstack/blob/main/.github/CLA.md).
